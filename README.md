...
> ❗ **강의 영상은 100% 무료**  
> ❗ **코드 & 자료만 GitHub Sponsors 후원으로 제공**
...
## 💻 그런데, 코드를 직접 따라 치기 어렵다면?
강의를 보며 **모든 코드를 직접 작성하는 것이 어려운 분들**을 위해  
다음과 같은 분들을 대상으로 **코드 & 자료 제공**을 하고 있습니다.

- 강의 속도가 빠르게 느껴지는 분
- 실전 자동매매 코드를 바로 참고하고 싶은 분
- 복습 / 커스터마이징용 코드가 필요한 분
